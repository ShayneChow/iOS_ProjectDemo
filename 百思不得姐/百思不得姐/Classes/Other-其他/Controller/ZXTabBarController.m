...
- (void)setupChildViewController {
    ...
    [self setupChildViewController:[[ZXMeViewController alloc] initWithStyle:UITableViewStyleGrouped] title:@"我" image:@"tabBar_me_icon" selectedImage:@"tabBar_me_click_icon"];
}
